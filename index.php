...
// Ở trên chủ  yếu tạo các đường dẫn đưa vào hằng số (dấu nhấy), cuối  chuyển file appload (bộ não đầu tiên)
// COREPATH - đã tạo đường dẫn ở trên, nghĩa là à đây là ifle thuộc core.(section-26/core/appload.php
