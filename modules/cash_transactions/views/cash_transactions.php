...
<head>
    ...
    <link rel="stylesheet" href="<?php echo asset_ver('public/css/cash_transactions/cash_transactions.css'); ?>">
...
<body>
    ...
    <script src="<?php echo asset_ver('public/js/cash_transactions/cash_transactions.js'); ?>"></script>
