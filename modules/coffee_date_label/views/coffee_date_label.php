...
<head>
    ...
    <link rel="stylesheet" href="<?php echo asset_ver('public/css/coffee_date_label/coffee_date_label.css'); ?>">
</head>
...
<body>
    ...
    <script src="<?php echo asset_ver('public/js/coffee_date_label/coffee_date_label.js'); ?>"></script>
