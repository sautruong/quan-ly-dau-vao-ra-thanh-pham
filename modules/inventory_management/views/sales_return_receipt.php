...
<head>
    ...
    <link rel="stylesheet" href="<?php echo asset_ver('public/css/inventory_management/sales_return_receipt.css'); ?>">
...
<body>
    ...
    <script src="<?php echo asset_ver('public/js/inventory_management/sales_return_receipt.js'); ?>"></script>
