...
<head>
    ...
    <style>
        ...
        .datatable-toolbar .rows-per-page {
            display: flex;
            align-items: center;
            gap: 8px;
        }
        ...
        .datatable-toolbar [data-rows-info] {
            color: #555;
        }
        ...
        <div class="content">
            <div class="data-actions" data-sticky-top>
                <form class="data-filter" method="get">
                    ...
                    <input type="hidden" name="action" value="finished_product_production_data">
            ...
            <div class="datatable-wrap" data-paginate-wrap>
                <div class="datatable-toolbar" data-sticky-top>
                    <div class="rows-per-page">
                        <label for="rpp-fpp">Số hàng hiển thị:</label>
                        <select id="rpp-fpp" data-rows-per-page>
