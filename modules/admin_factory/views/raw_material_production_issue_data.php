        ...
        <div class="content">
            <div class="data-actions" data-sticky-top>
                <form class="data-filter" method="get">
                    ...
                    <input type="hidden" name="action" value="raw_material_production_issue_data">
                    ...
                    <input type="hidden" name="material_id" value="<?php echo (int) ($material_id ?? 0); ?>">
            ...
            <div class="datatable-wrap" data-paginate-wrap>
                <div class="datatable-toolbar" data-sticky-top>
                    <div class="rows-per-page">
                        <label for="rpp-rmpi">Số hàng hiển thị:</label>
                        <select id="rpp-rmpi" data-rows-per-page>
                ...
                <table class="product-table" data-paginate data-sticky-thead>
                    <thead>
                        <tr>
                            <th>
                                <div class="wp-title">
                                    <div class="title">Tên nguyên vật liệu</div>
                                    <div class="btn-filter" data-filter-target="material_id"
                                         data-search-type="materials" data-filter-title="Lọc tên nguyên vật liệu">
                    ...
                    <tbody>
                        ...
                        <?php else: foreach ($rows as $r):
                            ...
                            $mname = $r['material_name'] ?: ('#' . (int) $r['material_id']);
