...
<body>
        ...
        <div id="sidebar-right">
            ...
            <div class="main-content">
                <div class="wp-content-add-product">
                    <p class="name-title">SỬA SẢN PHẨM</p>
                    ...
                    <form enctype="multipart/form-data"
                          action="?mod=product_profile&controllers=product_profile&action=ready_edit_product&id=<?= $data['product']['id'] ?>"
                          method="POST" id="form-edit-product">
                        ...
                        <!-- Hình ảnh -->
                        <?php if (!empty($data['product']['image_url'])): ?>
                            <div class="current-image">
                                <img src="public/images/<?= $data['product']['image_url'] ?>" alt="">
                                <span>Hình ảnh hiện tại (chọn file mới để thay đổi)</span>
                            </div>
                        <?php endif; ?>
                        <div class="wp-upload">
                            <input type="file" name="product_image" id="file_upload" accept=".jpg,.jpeg,.png,.gif,.webp,.bmp" hidden>
                            <input type="text" id="file_name" placeholder="Chọn hình ảnh mới (không bắt buộc)" readonly>
                        ...
                        <div class="wp-input-row">
                            ...
                            <input type="text" id="unit" name="unit" placeholder="VD: Kg, Hộp, Chai..."
                                   value="<?= htmlspecialchars($data['basic']['unit'] ?? '') ?>">
                        </div>
                        ...
                        <div class="wp-input-row">
                            ...
                            <input type="text" id="inner_packaging" name="inner_packaging" placeholder="Nhập bao bì trong"
                                   value="<?= htmlspecialchars($data['basic']['inner_packaging'] ?? '') ?>">
                        </div>
                        ...
                        <div class="wp-input-row">
                            ...
                            <input type="text" id="outer_packaging" name="outer_packaging" placeholder="Nhập bao bì ngoài"
                                   value="<?= htmlspecialchars($data['basic']['outer_packaging'] ?? '') ?>">
                        </div>
                        ...
                        <div class="wp-input-row">
                            ...
                            <input type="text" id="inner_packaging_spec" name="inner_packaging_spec" placeholder="Nhập quy cách bao bì trong"
                                   value="<?= htmlspecialchars($data['basic']['inner_packaging_spec'] ?? '') ?>">
                        </div>
                        ...
                        <div class="wp-input-row">
                            ...
                            <input type="text" id="outer_packaging_spec" name="outer_packaging_spec" placeholder="Nhập quy cách bao bì ngoài"
                                   value="<?= htmlspecialchars($data['basic']['outer_packaging_spec'] ?? '') ?>">
                        </div>
                        ...
                        <div class="wp-input-row">
                            ...
                            <input type="text" id="cost_price" name="cost_price" placeholder="Nhập giá vốn"
                                   value="<?= htmlspecialchars($data['pricing']['cost_price'] ?? '') ?>">
                        </div>
    ...
    <script defer>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            // Load các material đã có từ PHP
            var selectedMaterials = <?= json_encode(array_map(function ($m) {
                return [
                    'id' => $m['id'],
