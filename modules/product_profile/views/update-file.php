...
<head>
    ...
    <!-- <script src="<?php echo asset_ver('public/js/product_profile_list.js'); ?>" defer></script> -->
        ...
        <div id="sidebar-right">
            ...
            <div class="main-content">
                <div class="wp-content-addfile">
                    <p>Cập nhật file cho sản phẩm: <strong><?= mb_strtoupper($data['product_name']) ?></strong></p>

                    <!-- Hiển thị file cũ -->
                    <?php if (!empty($data['file_path'])): ?>
                        <div class="wp-old-file">
                            <i class="fa-solid fa-file"></i>
                            <a href="public/uploads/<?= $data['file_path'] ?>" target="_blank">
                                <?= $data['file_name'] ?>
                            </a>
                        </div>
                    <?php endif; ?>
                    ...
                    <form enctype="multipart/form-data"
                          action="?mod=product_profile&controllers=product_profile&action=ready_update_file&id_product=<?= $data['id_product'] ?>&id_file=<?= $data['id_file'] ?>"
                          method="POST">
                        <div class="wp-name-file">
                            <label for="name_file">Đặt tên file:</label>
                            <input type="text" id="name_file" name="file_label" value="<?= htmlspecialchars($data['file_name'] ?? '') ?>">
                        </div>
                        <div class="wp-upload">
