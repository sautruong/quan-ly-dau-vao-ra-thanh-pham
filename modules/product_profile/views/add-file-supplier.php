        ...
        <div id="sidebar-right">
            ...
            <div class="main-content">
                <div class="wp-content-addfile">
                    <p>Bổ sung file liên quan đến:  <strong> <?= mb_strtoupper($data['supplier_name']) ?></strong></p>
                    <form enctype="multipart/form-data" action="?mod=product_profile&controllers=product_profile&action=ready_add_file_supplier&id=<?= $data['id'] ?>&product_id=<?= $data['product_id'] ?>" method="POST">
