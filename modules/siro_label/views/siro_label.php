...
<head>
    ...
    <link rel="stylesheet" href="<?php echo asset_ver('public/css/siro_label/siro_label.css'); ?>">
</head>
...
<body>
    ...
    <script src="<?php echo asset_ver('public/js/siro_label/siro_label.js'); ?>"></script>
