...
<head>
    ...
    <title>Luồng một nguyên vật liệu</title>
    ...
    <link rel="stylesheet" href="<?php echo asset_ver('public/css/accounting_factory/flow.css'); ?>">
...
<body>
            ...
            <div class="af-wrap">
                <div class="af-controls">
                    <div class="af-field af-search">
                        <label for="af-keyword">Nguyên vật liệu</label>
                        <input type="text" id="af-keyword" autocomplete="off" placeholder="Tìm nguyên vật liệu theo tên...">
                ...
                <div class="af-empty" id="af-empty">Chọn nguyên vật liệu và khoảng thời gian để xem luồng.</div>

                <div class="af-report" id="af-report">
                    <div class="af-sheet-head">
                        <p class="af-company">Công ty TNHH Vua An Toàn</p>
                        <h2>LUỒNG MỘT NGUYÊN VẬT LIỆU</h2>
                    ...
                    <div class="af-section">
                        <h3>Nhập kho (mua nguyên vật liệu)</h3>
                        <table class="af-table">
                            <thead><tr><th>Ngày</th><th>Số lượng</th><th>Giá trị</th></tr></thead>
                            <tbody id="af-nhap-kho"></tbody>
                            <tfoot><tr><td class="l">Tổng</td><td id="af-nk-qty">0</td><td id="af-nk-val">0 đ</td></tr></tfoot>
                        </table>
                    </div>
                    ...
                    <div class="af-section">
                        <h3>Xuất nguyên vật liệu dùng sản xuất</h3>
                        <table class="af-table">
                            <thead><tr><th>Ngày</th><th>Số lượng</th><th>Giá trị</th></tr></thead>
                            <tbody id="af-xuat-sx"></tbody>
                            <tfoot><tr><td class="l">Tổng</td><td id="af-xsx-qty">0</td><td id="af-xsx-val">0 đ</td></tr></tfoot>
                        </table>
                    </div>
                </div>
            </div>
    ...
    <script src="<?php echo asset_ver('public/js/accounting_factory/flow.js'); ?>"></script>
